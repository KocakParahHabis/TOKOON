...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('backend/images/logo-universitas-bina-sarana-informatika-ubsi.png')}}">
    <!-- Custom CSS -->
    ...
    <link href="{{ asset('backend/assets/libs/bootstrap/dist/css/bootstrap.min.css') }}" rel="stylesheet">
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                Web Programming 2. Toko Online <a
